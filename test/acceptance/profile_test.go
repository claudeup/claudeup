...
func TestProfileSaveAndLoad(t *testing.T) {
	...
	snapshot, err := profile.Snapshot("my-dev-setup", env.ClaudeDir, env.ClaudeJSONPath, env.ClaudeupDir())
	if err != nil {
...
func TestProfileCreate(t *testing.T) {
	...
	snapshot, err := profile.Snapshot("minimal-profile", env.ClaudeDir, env.ClaudeJSONPath, env.ClaudeupDir())
	if err != nil {
		t.Fatalf("Failed to create snapshot: %v", err)
	}
...
func TestProfileOverwrite(t *testing.T) {
	...
	snapshot, err := profile.Snapshot("test-profile", env.ClaudeDir, env.ClaudeJSONPath, env.ClaudeupDir())
	if err != nil {
		t.Fatalf("Failed to create snapshot: %v", err)
	}
...
func TestEmptyStateSnapshot(t *testing.T) {
	...
	snapshot, err := profile.Snapshot("empty-profile", env.ClaudeDir, env.ClaudeJSONPath, env.ClaudeupDir())
	if err != nil {
